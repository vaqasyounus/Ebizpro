...
public class ReportProfitLossActivity extends AppCompatActivity implements IDatabaseCallback, View.OnClickListener {
    Spinner spinner_one;
    Spinner spinner_two;
...
//        toDate.setText(fromDateFormat.format(myCalendar.getTime()));
        ...
        t1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(ReportProfitLossActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int monthofyear, int dayOfMonth) {
                        ...
                        if (spinner_two.getSelectedItem().toString().trim().equalsIgnoreCase("All")) {
                            ...
                            query_cate = "select * from VWMProfitLoss where Category = '" + spinner_two.getSelectedItem().toString() + "' AND Location = '" + spinner_two.getSelectedItem() + "'";
                        ...
                        backgroudTask = new BackgroudTask(consultant.eyecon.activities.ReportProfitLossActivity.this, 3);
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(ReportProfitLossActivity.this, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int monthofyear, int dayOfMonth) {
                        ...
                        if (spinner_two.getSelectedItem().toString().trim().equalsIgnoreCase("All")) {
                            ...
                            query_cate = "select * from VWMProfitLoss where Category = '" + spinner_one.getSelectedItem().toString() + "' AND Location = '" + spinner_two.getSelectedItem() + "'";
                            //query_cate = "select * VWMProfitLoss where Category " + spinner_one.getSelectedItem().toString() + " = '" + parent.getSelectedItem().toString() + "'";
...
//
//
        String quer_loc = "SELECT top 4 c.name AS column_name from sys.views  AS t INNER JOIN sys.columns c ON t.OBJECT_ID = c.OBJECT_ID where t.name='VWMProfitLoss'";
        backgroudTask = new BackgroudTask(consultant.eyecon.activities.ReportProfitLossActivity.this, 4);
        backgroudTask.execute(quer_loc);


        String query_loc = "SELECT     TOP (1000)  dbo.Tbl_UtilityDetail.UtilityDetValue AS BuName FROM         dbo.Tbl_Utility INNER JOIN dbo.Tbl_UtilityDetail ON dbo.Tbl_Utility.UtilityID = dbo.Tbl_UtilityDetail.UtilityID where dbo.Tbl_UtilityDetail.UtilityID=1";
        backgroudTask = new BackgroudTask(consultant.eyecon.activities.ReportProfitLossActivity.this, 1);
        ...
        backgroudTask = new BackgroudTask(consultant.eyecon.activities.ReportProfitLossActivity.this, 2);
        backgroudTask.execute(query_cate);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
               ...
               if (date.isEmpty() && toda.isEmpty()) {
                    if((spinner_one.getSelectedItem().toString().trim().equalsIgnoreCase("All"))){
                       query_cate = "select * from VWMProfitLoss ";
                   }
                       ...
                       query_cate = "select * from VWMProfitLoss where Category = '" + spinner_two.getSelectedItem().toString() + "' AND Location = '" + spinner_one.getSelectedItem() + "'";
                        ...
                        query_cate = "select * from VWMProfitLoss where Category = '"+spinner_two.getSelectedItem().toString()+"'";
                        // String query_cat = "select * from VWMProfitLoss where
                        // query_cate=query_cate+"Sales_date <'" +toda+ "'";;
                        ...
                        query_cate = "select * from VWMProfitLoss where Location = '"+parent.getSelectedItem().toString()+"'";
                        // String query_cat = "select * from VWMProfitLoss where
                        // query_cate=query_cate+"Sales_date <'" +toda+ "'";;
                        ...
                        query_cate = "select * from VWMProfitLoss where Location = '" + spinner_one.getSelectedItem().toString() + "' AND  Category= '" + spinner_two.getSelectedItem() + "'";
                    }
                }
                else {
                   if((spinner_one.getSelectedItem().toString().trim().equalsIgnoreCase("All"))){
                       query_cate = "select * from VWMProfitLoss where Sales_date >='" + date + "' AND Sales_date <='" + toda + "' AND Category = '" + spinner_two.getSelectedItem().toString() + "' AND Location = '" + spinner_one.getSelectedItem() + "'";
                    ...
                    query_cate = "select * from VWMProfitLoss where Category = '" + parent.getSelectedItem().toString() + "' AND Location = '" + spinner_one.getSelectedItem() + "'";
                    //query_cate = "select * VWMProfitLoss where Category " + spinner_one.getSelectedItem().toString() + " = '" + parent.getSelectedItem().toString() + "'";
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
              ...
              if (date.isEmpty() && toda.isEmpty()) {
                  if((spinner_one.getSelectedItem().toString().trim().equalsIgnoreCase("All"))){
                      ...
                      query_cate = "select * from VWMProfitLoss where Category = '"+parent.getSelectedItem().toString()+"'";
                      // String query_cat = "select * from VWMProfitLoss where
                      // query_cate=query_cate+"Sales_date <'" +toda+ "'";;
                        ...
                        query_cate = "select * from VWMProfitLoss where Location = '"+spinner_one.getSelectedItem().toString()+"'";
                  ...
                  if((spinner_one.getSelectedItem().toString().trim().equalsIgnoreCase("All"))){
                      query_cate = "select * from VWMProfitLoss where Sales_date >='" + date + "' AND Sales_date <='" + toda + "'";
...
//                    fourth.setText("" + locationsName.get(3));
            ...
            try {
                if (resultSet != null) {
                    ...
                    RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(consultant.eyecon.activities.ReportProfitLossActivity.this);
                    recyclerView.setLayoutManager(layoutManager);
                    adapter = new ReportAdapter(consultant.eyecon.activities.ReportProfitLossActivity.this, data);
