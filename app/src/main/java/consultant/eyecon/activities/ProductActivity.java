...
public class ProductActivity extends AppCompatActivity implements IDatabaseCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String partyLedgerActivity=getIntent().getStringExtra("PartyName");
        String query_loc = "SELECT     TrDate, Debit, Credit, Remarks FROM         dbo.VwMLedger WHERE PartyName = '"+partyLedgerActivity+"'";
        backgroudTask = new BackgroudTask(ProductActivity.this, 2);
            ...
            case R.id.search:
                ...
                try {
                    ...
                    if (from.compareTo(to) > 0) {
                        Toast.makeText(ProductActivity.this, "invalid date", Toast.LENGTH_SHORT).show();
                    } else {
//
            ...
            case android.R.id.home:
                Intent intent=new Intent(ProductActivity.this,ReportPartyLedgerActivity.class);
            ...
            try {
                if (resultSet != null) {
                    ...
                    recyclerView.setLayoutManager(layoutManager);
                     adapter = new BookingAdapter(ProductActivity.this, data);
